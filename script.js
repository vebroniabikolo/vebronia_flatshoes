const PRODUCTS = [
  {
    ...
    colors: [
      ...
      { name: "Gunmetal", hex: "#2A3439", image: "image/produk 1-3.jpg" },
  ...
  },
  {
    ...
    colors: [
      { name: "Cokelat", hex: "#D2691E", image: "image/produk 3-2.jpg" },
      { name: "Emas", hex: "#B8860B", image: "image/produk 3-3.jpg" },
  ...
  },
  {
    ...
    colors: [
      ...
      { name: "Burgundy", hex: "#800020", image: "image/produk 4-4.jpg" },
  ...
  },
  {
    ...
    colors: [
      { name: "Cokelat", hex: "#D2691E", image: "image/produk 8-1.jpg" },
      { name: "Gold", hex: "#F6E9C8", image: "image/produk 8-1.jpg" },
      { name: "Silver", hex: "#C0C0C0", image: "image/produk 8-1.jpg" },
      { name: "Hitam", hex: "#070707ff", image: "image/produk 8-1.jpg" }
    ],
    category: "zalsa",
  ...
  },
  {
    ...
    colors: [
      { name: "Leopard tan", hex: "#C29F6B", image: "image/produk 9-1.jpg" },
      { name: "Brown", hex: "#4E3629", image: "image/produk 9-1.jpg" },
      { name: "Leopard Brown", hex: "#8E6D4E", image: "image/produk 9-1.jpg" },
      { name: "Hitam", hex: "#070707ff", image: "image/produk 9-1.jpg" }
    ],
    category: "joana",
  ...
  },
  {
    ...
    colors: [
      ...
      { name: "Cokelat", hex: "#964B00", image: "image/produk 14-3.jpg" },
      { name: "Silver", hex: "#C0C0C0", image: "image/produk 14-4.jpg" },
      { name: "Emas", hex: "#c28e0bff", image: "image/produk 14-5.jpg" }
    ],
    category: "zalsa",
  ...
  },
  {
    ...
    colors: [
      ...
      { name: "Bronze", hex: "#4B0082", image: "image/produk 24-4.jpg" }
    ],
    category: "cheung",
...
// ===================================================================
  ...
  function slideImg(n) {
    ...
    modalImgWrap.style.transform = `translateX(${offset}%)`;
  }
  ...
  if (modalScroller) {
    modalScroller.addEventListener('touchstart', e => {
      touchstartX = e.changedTouches[0].screenX;
    }, false);

    // Tambahkan listener untuk mendeteksi akhir sentuhan
    modalScroller.addEventListener('touchend', e => {
...
// MODIFIED: modalBuy (similar changes)
modalBuy.addEventListener('click', ()=>{
    ...
    if (addToCartDetailed({
        ...
        closeModal();
        openCart();
        alert('Checkout simulasi: Terima kasih, pesanan ditambahkan. Lanjut ke pembayaran (simulasi).');
    }
});
...
checkoutBtn.addEventListener('click', ()=>{
  ...
  // simulate checkout
  let text = "Checkout simulasi:\n\n";
  let total = 0;
  cart.forEach(ci=>{
    text += `${ci.name} | ${ci.color} | size ${ci.size} × ${ci.qty} — ${fmt(ci.subtotal)}\n`;
    total += ci.subtotal;
  });
  text += `\nTotal: ${fmt(total)}\n\nOK untuk konfirmasi (simulasi)?`;
  if(confirm(text)){
    alert('Terima kasih! Pesanan terkonfirmasi (simulasi).');
    cart = [];
    saveCart();
    renderCartDrawer();
    updateCartCount();
